...
\textbf{The interval hull} {\small \parencite{Puig2005}}
...
\begin{figure}[H] 
  \centering 
  \begin{tabular}{l}
  \subfloat[Discrete ambiguity]{\adjustbox{raise=-3.6pc}{
  %\includegraphics[width=0.27\textwidth]{../img/he-discrete.png}
  }\label{fig:destination}}\ 
  \subfloat[Continuous ambiguity]{\adjustbox{raise=-3.6pc}{
  %\includegraphics[width=0.27\textwidth]{../img/he-interval.png}
  \label{fig:driving-style}}}\
    \subfloat[Results]{
