...
\begin{figure}[tp]
    \centering
    \includegraphics[width=0.6\textwidth]{img/ukl-eps-converted-to}
...
\begin{figure}[pht]
    ...
    \includegraphics[width=0.64\textwidth]{img/ODP_svg-tex}    \includegraphics[width=0.64\textwidth]{img/OLOP_svg-tex}
    \includegraphics[width=0.64\textwidth]{img/KL-OLOP_svg-tex}
