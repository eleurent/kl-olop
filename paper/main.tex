...
\subfloat{
	\includegraphics[width=0.33\textwidth]{img/hw_return_svg-tex}
	\label{sub:highway}
}
\subfloat{
	\includegraphics[width=0.33\textwidth]{img/gw_return_svg-tex}
	\label{sub:gridworld}
}
\subfloat{
	\includegraphics[width=0.33\textwidth]{img/gw_stoch_return_svf-tex}
	\label{sub:gridworld_stoch}
}
...
\begin{figure}[pht]
	...
	\includegraphics[width=0.43\textwidth]{img/tree-ODP_svg-tex} \includegraphics[width=0.43\textwidth]{img/tree-OLOP_svg-tex}
	\includegraphics[width=0.43\textwidth]{img/tree-KL-OLOP_svg-tex}
